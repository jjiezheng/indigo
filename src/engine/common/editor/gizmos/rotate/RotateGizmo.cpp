...
//      testDirection = startSelectedOrientation_.mat3x3() * Vector3::RIGHT;
//      Vector3 planeNormalCrossRight = planeNormal.vec3().cross(Vector3::RIGHT).normalize();
////      angleDirection = planeNormalCrossRight.y > 0 ? angleDirection : -angleDirection;
//      
//      if (planeNormalCrossRight.y < 0) {
//        planeNormal = planeNormal.inverse();
//        testDirection = testDirection.inverse();
//      }
//      
//      LOG("before %f %f %f", planeNormal.x, planeNormal.y, planeNormal.z);
////      LOG("%f", angleDirection);
//    }
//      break;
//      
