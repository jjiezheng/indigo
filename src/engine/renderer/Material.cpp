...
void Material::bind(const Matrix4x4& projection, const Matrix4x4& view, const Matrix4x4& model, const SceneContext& sceneContext, IEffect* effect) const {  
  ...
  Matrix4x4 normalMatrix = worldView.mat3x3().inverseTranspose();
